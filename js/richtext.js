...
function window_open(ourl,p1,p2) {
 return window.open(ourl,p1,p2);
}
function rteBtnInsertImage() {
    window.window_open(rteHTMLPathInsertImage, "blank", "toolbar=no,width=300,height=220");
};
function rteBtnEditLink() {
    window.window_open(rteHTMLPathEditLink, "blank", "toolbar=no,width=250,height=300");
};
function rteBtnEditTable() {
    window.window_open(rteHTMLPathEditTable, "blank", "toolbar=no,width=320,height=210");
};
function rteBtnCreateLink() {
    window.window_open(rteHTMLPathInsertLink, "blank", "toolbar=no,width=250,height=300");
};
...
function rteBtnInsertForm() {
    window.window_open(rteHTMLPathInsertForm, "blank", "toolbar=no,width=320,height=180");
};
function rteBtnInsertCheckbox() {
    window.window_open(rteHTMLPathInsertCheckbox, "blank", "toolbar=no,width=320,height=150");
};
function rteBtnInsertRadio() {
    window.window_open(rteHTMLPathInsertRadiobutton, "blank", "toolbar=no,width=320,height=150");
};
function rteBtnInsertFlash() {
    window.window_open(rteHTMLPathInsertFlash, "blank", "toolbar=no,width=350,height=130");
};
function rteBtnInsertTextArea() {
    window.window_open(rteHTMLPathInsertTextArea, "blank", "toolbar=no,width=320,height=230");
};
function rteBtnInsertSubmit() {
    window.window_open(rteHTMLPathInsertSubmit, "blank", "toolbar=no,width=320,height=130");
};
function rteBtnInsertImageSubmit() {
    window.window_open(rteHTMLPathInsertImageSubmit, "blank", "toolbar=no,width=320,height=130");
};
function rteBtnInsertReset() {
    window.window_open(rteHTMLPathInsertReset, "blank", "toolbar=no,width=320,height=130");
};
function rteBtnInsertHidden() {
    window.window_open(rteHTMLPathInsertHidden, "blank", "toolbar=no,width=320,height=130");
};
function rteBtnInsertPassword() {
    window.window_open(rteHTMLPathInsertPassword, "blank", "toolbar=no,width=320,height=150");
};
function rteBtnInsertText() {
    window.window_open(rteHTMLPathInsertText, "blank", "toolbar=no,width=320,height=170");
};
function rteAbout() {
    msg = window.window_open("", "msg", "height=100,width=320");
...
function rteBtnInsertTable() {
    window.window_open(rteHTMLPathInsertTable, "blank", "toolbar=no,width=320,height=240");
};
...
function initRTE(rtePreloadContent, rteCSS) {
    if (!document.designMode) {
     ...
     //   document.write('	background-image:url(' + rteImagePath + 'bgover.gif);');
        ...
        document.write('	display:block;');
        document.write('	border:1px solid #00000080;');
       // document.write('	background-image:url(' + rteImagePath + 'bgdown.gif);');
        document.write('	cursor:default;');
        document.write('	padding: 2px;');
        document.write('}');
        ...
        document.write('        <td id="rtefontface">');
        ...
        document.write('        </td>');
        document.write('        <td class="rtebg"><img src="' + rteImagePath + 'blank.gif"></td>');
        document.write('        <td id="rtefontsize">');
        ...
        document.write('    </td>');
        document.write('  <tr>');
        document.write('    <td style="border:1px solid #b0b0b080; ">');
        ...
        document.write('  </tr>');
        document.write('  <tr>');
        document.write('    <td height="25" class="rtebg">');
        ...
        if (rteDesignMode) {
            ...
            document.write('							<td style="display:none;color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn9" id="rte_design_mode"><img src="' + rteImagePath + 'design.gif">&nbsp;D�zenle</div></td>');
        }
        if (rteCodeMode) {
            document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_code_mode" onclick="rteModeType(\'rte_code_mode\');"><img src="' + rteImagePath + 'code.gif">&nbsp;HTML</div></td>');
        }
        else {
        ...
        if (rtePreviewMode) {
            document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_preview_mode" onclick="rteModeType(\'rte_preview_mode\');"><img src="' + rteImagePath + 'preview.gif">&nbsp;G�r�n�m</div></td>');
        }
        else {
